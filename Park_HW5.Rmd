...
# median parameter estimates for y and y_measured
median.boot1 <- c(median(sample_coef_intercept1), median(sample_coef_x1_for_y))
median.boot1 
# confidence interval at 95% of the estimated is close to the true slope
a <-
  cbind(
...
ridge.mod <- glmnet(matrix_mod, train.College$Apps)
# END SOLUTION
```
